...
export function ThemeBackground() {
    return (
        <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden select-none bg-[#f8fafc] dark:bg-[#121417] transition-colors duration-300">
            ...
            <div className="absolute -top-[15%] -left-[10%] w-[800px] h-[800px] rounded-full bg-gradient-to-br from-emerald-400/10 via-[#0284c7]/8 to-transparent blur-[140px] animate-pulse-slow" />
            ...
            <div className="absolute -bottom-[10%] -left-[10%] w-[900px] h-[900px] rounded-full bg-gradient-to-tr from-[#0284c7]/8 via-emerald-500/5 to-transparent blur-[160px] animate-float" />
