                    ...
                    <div className="container px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 mx-auto">
                        <div className="space-y-8">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight text-white">
                                ...
                                <span className="text-[#00e699]">Mutual Funds</span>
                            </h1>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-800">
                                <div>
                                    <p className="text-3xl font-black text-[#00e699]">₹500</p>
                                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Min SIP Amount</p>
                                </div>
                                <div>
                                    <p className="text-3xl font-black text-white">0%</p>
                                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Direct Commission</p>
                                </div>
                                <div>
                                    <p className="text-3xl font-black text-amber-400">15%+ p.a.</p>
                                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Historical Returns</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <Card className="bg-[#24272c] border border-slate-800 rounded-[2.5rem] p-8 text-white shadow-2xl space-y-6 w-full max-w-md">
                                <div className="flex items-center gap-4 border-b border-slate-800 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-400 font-medium">Direct Growth Mutual Funds</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center bg-slate-900/60 p-3.5 rounded-2xl border border-slate-800 text-xs">
                                        <span className="text-slate-400 font-bold">SIP Starting</span>
                                        <span className="font-black text-[#00e699] text-sm">₹500 / Month</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-slate-900/60 p-3.5 rounded-2xl border border-slate-800 text-xs">
                                        <span className="text-slate-400 font-bold">Tax Savings (ELSS)</span>
                                        <span className="font-black text-white text-sm">Up to ₹46,800 Tax Saved</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-slate-900/60 p-3.5 rounded-2xl border border-slate-800 text-xs">
                                        <span className="text-slate-400 font-bold">Fund Partners</span>
                ...
                <div className="space-y-12">
                    ...
                    <div className="p-8 rounded-3xl bg-[#24272c] border border-slate-800 shadow-xl text-white">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-2xl font-black text-white">SIP Investment Calculator</h3>
                        </div>
                        <SIPCalculator />
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-2xl font-black text-white">Key Benefits</h3>
                            </div>
                            <SimpleAccordion
                                items={[
                    ...
                    <div id="lead-form" className="sticky top-28">
                        <Card className="bg-[#24272c] border border-slate-800 shadow-2xl rounded-[2.5rem] overflow-hidden text-white">
                            <CardHeader className="bg-gradient-to-r from-lime-400 via-emerald-400 to-teal-400 text-slate-950 p-8">
                                <span className="text-[10px] font-black uppercase tracking-widest bg-slate-950 text-white px-3 py-1 rounded-full w-fit">0% Commission Direct Funds</span>
                            ...
                            <CardContent className="p-8 space-y-4">
                                {isSuccess ? (
                                    <div className="text-center py-8 space-y-3">
                                        ...
                                        <p className="text-xs text-slate-400">Our wealth advisor will contact you shortly.</p>
                                    </div>
                                ) : (
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            <label className="text-[10px] font-black uppercase text-slate-400">Monthly SIP Amount</label>
                                            <Input
