                    ...
                    <div className="container px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 mx-auto">
                        <div className="space-y-8">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-tight text-slate-900">
                                Build Your <br />
                                <span className="text-[#0284c7]">Empire.</span>
                            </h1>
                            ...
                            <Card className="bg-white border border-slate-200 rounded-[2.5rem] p-8 text-white shadow-2xl space-y-6 w-full max-w-md">
                                <div className="flex items-center gap-4 border-b border-slate-200 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 font-medium">No Asset Collateral Needed</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                        ...
                                        <span className="font-black text-[#0284c7] text-sm">Up to ₹75 Lakhs</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                    ...
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                        <span className="text-slate-500 font-bold">Tenure Options</span>
            ...
            <section className="py-16 relative z-20">
                <div className="container px-4 mx-auto">
                    <div className="grid md:grid-cols-3 gap-6 text-center">
                        {[
                            { title: "Working Capital", desc: "For daily business operations", icon: BarChart3, color: "text-[#0284c7]" },
                            { title: "Equipment Finance", desc: "Upgrade machinery & tech", icon: Building2, color: "text-amber-400" },
                            { title: "Business Expansion", desc: "Open new branch locations", icon: Briefcase, color: "text-[#0284c7]" }
                        ].map((item, i) => (
                ...
                <div className="space-y-12">
                    ...
                    <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md text-white">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-2xl font-black text-slate-900">Calculate Business Loan EMI</h3>
                        </div>
                    ...
                    <div id="lead-form" className="sticky top-28">
                        <Card className="bg-white border border-slate-200 shadow-2xl rounded-[2.5rem] overflow-hidden text-white">
                            <CardHeader className="bg-gradient-to-r from-sky-700 via-sky-600 to-sky-800 text-slate-950 p-8">
                                <span className="text-[10px] font-black uppercase tracking-widest bg-[#f8fafc] text-white px-3 py-1 rounded-full w-fit">MSME Special Rate</span>
                            ...
                            <CardContent className="p-8 space-y-4">
                                {isSuccess ? (
                                    <div className="text-center py-8 space-y-3">
                                        ...
                                        <p className="text-xs text-slate-500">Our MSME loan expert will contact you shortly.</p>
                                    </div>
                                ) : (
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div>
                                            <label className="text-[10px] font-black uppercase text-slate-500">Promoter Name</label>
                                            <Input
                                        ...
                                        <div>
                                            <label className="text-[10px] font-black uppercase text-slate-500">Annual Turnover</label>
                                            <Input
