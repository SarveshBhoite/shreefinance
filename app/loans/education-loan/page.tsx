                    ...
                    <div className="container px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 mx-auto">
                        <div className="space-y-8">
                            <div className="inline-flex items-center gap-2 rounded-full border border-sky-500/30 bg-sky-50 px-4 py-1.5 text-xs font-black text-[#0284c7] uppercase tracking-widest">
                                <GraduationCap className="h-4 w-4 text-[#0284c7]" />
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-tight text-slate-900">
                                Invest in Your <br />
                                <span className="text-[#0284c7]">Future Success.</span>
                            </h1>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-200">
                                <div>
                                    <p className="text-3xl font-black text-[#0284c7]">9.50%</p>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">Tuition Cover</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <Card className="bg-white border border-slate-200 rounded-[2.5rem] p-8 text-white shadow-2xl space-y-6 w-full max-w-md">
                                <div className="flex items-center gap-4 border-b border-slate-200 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 font-medium">US, UK, Canada, Europe & India</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                        ...
                                        <span className="font-black text-[#0284c7] text-sm">Starting 9.50% p.a.</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                        <span className="text-slate-500 font-bold">Moratorium Period</span>
                                        <span className="font-black text-white text-sm">Course + 1 Year</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-slate-200 text-xs">
                                        <span className="text-slate-500 font-bold">Tax Benefit</span>
                ...
                <div className="space-y-12">
                    ...
                    <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md text-white">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-2xl font-black text-slate-900">Calculate Education Loan EMI</h3>
                        </div>
                    ...
                    <div id="lead-form" className="sticky top-28">
                        <Card className="bg-white border border-slate-200 shadow-2xl rounded-[2.5rem] overflow-hidden text-white">
                            <CardHeader className="bg-gradient-to-r from-sky-700 via-sky-600 to-sky-800 text-slate-950 p-8">
                                <span className="text-[10px] font-black uppercase tracking-widest bg-[#f8fafc] text-white px-3 py-1 rounded-full w-fit">Pre-Visa Disbursal</span>
                            ...
                            <CardContent className="p-8 space-y-4">
                                {isSuccess ? (
                                    <div className="text-center py-8 space-y-3">
                                        ...
                                        <p className="text-xs text-slate-500">Our student loan advisor will contact you shortly.</p>
                                    </div>
                                ) : (
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            <label className="text-[10px] font-black uppercase text-slate-500">Target Course / Country</label>
                                            <Input
